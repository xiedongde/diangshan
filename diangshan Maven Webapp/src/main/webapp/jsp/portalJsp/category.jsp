					...
					<div class="brand_box float_left">
						<ul>
							<c:forEach items="${likeNameList }" var="l">
								<li class="float_left"><a href="product/categoryFiltrate?dateDay=-20&likeName=${likeName }&brand=${l.brand }">${l.brand }</a></li>
							</c:forEach>
						</ul>
					</div>
				</div>
				<div class="order">
					...
					<div class="order_box float_left">
						<ul class="order_box_ul1 float_left">
							...
							<li class="float_left"><a href="product/categoryFiltrate?dateDay=-20&likeName=${likeName }&orderByPrice=9">由低到高</a></li>
							<li class="float_left"><a href="product/categoryFiltrate?dateDay=-20&likeName=${likeName }&jianprice=1&orderByPrice=9">由高到低</a></li>
							<li class="float_left">
								<form action="product/categoryFiltrate?dateDay=-20&likeName=${likeName }">
									...
									<input type="text"  name="dateDay" placeholder="￥" value="-20" style="display: none;"/>
				...
				<div class="price">
					<div class="order_box">
						<ul class="order_box_ul2">
							...
							<li class="float_left"><a href="product/categoryFiltrate?dateDay=-20&likeName=${likeName }&orderByTime=9">由远到近</a></li>
							<li class="float_left"><a href="product/categoryFiltrate?dateDay=-20&likeName=${likeName }&jianTime=1&orderByTime=9">由近到远</a></li>
						</ul>
					</div>
				</div>
			</div>
